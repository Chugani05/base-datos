...
select * from ordenes as o left join clientes as c on o.id_cliente=c.id_cliente union all select * from ordenes as o right join productos as p on o.id_producto=p.id_producto
/**
**/
